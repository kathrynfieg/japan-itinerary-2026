...
export const days: Day[] = [
  ...
  },
  {
    ...
    summary:
      'A relaxed final day exploring Osaka Castle, cycling through the castle park and riverside, with the afternoon reserved for a sumo experience or leisurely exploring before one final evening in Dotonbori.',
    ...
    activities: [
      ...
      },
      {
        ...
        type: 'food',
        notes: [
          'Start the final day with a relaxed breakfast.',
          'Leave around 9:00 AM for Osaka Castle.',
        ],
      },
      {
        time: 'Plan B · 9:30 AM',
        ...
        notes: [
          ...
          'Visit the museum inside if interested.',
          'Take plenty of photos before the crowds arrive.',
          'Allow around 2 hours.',
        ],
      },
      {
        time: 'Plan B · 11:45 AM',
        title: 'Rent bikes & explore Osaka Castle Park',
        place: 'Osaka Castle Park',
        maps: 'https://www.google.com/maps/search/?api=1&query=Osaka+Castle+Park',
        type: 'sight',
        notes: [
          'Rent bikes nearby.',
          'Cycle through Osaka Castle Park.',
          'Follow the Okawa River towards Sakuranomiya Park.',
          'Mostly flat, relaxing ride with great city views.',
          'Ride for around 1–1.5 hours.',
        ],
      },
      {
        time: 'Plan B · 1:30 PM',
        title: 'Lunch',
        place: 'Near Osaka Castle or Namba',
        type: 'food',
        notes: [
          'Find somewhere that looks good nearby.',
          'No reservations needed.',
        ],
      },
      {
        time: 'Plan B · 3:00 PM',
        title: 'Sumo Experience (if available)',
        place: 'Osaka',
        type: 'experience',
        notes: [
          'Check for an afternoon sumo demonstration or cultural experience.',
          'If unavailable, spend the afternoon relaxing or exploring nearby neighbourhoods.',
        ],
      },
      {
        time: 'Plan B · 5:30 PM',
        title: 'Return to Namba',
        place: 'Namba',
        maps: 'https://www.google.com/maps/search/?api=1&query=Namba+Osaka',
        type: 'stay',
        notes: [
          'Freshen up before heading out for the evening.',
          'Drop off any shopping.',
        ],
      },
      {
        time: 'Plan B · 6:30 PM',
        title: 'Final night in Dotonbori',
        place: 'Dotonbori',
        maps: 'https://www.google.com/maps/search/?api=1&query=Dotonbori+Osaka',
        type: 'food',
        notes: [
          'Enjoy one last dinner in Japan.',
          'Eat anything still on the bucket list.',
          'Take in the atmosphere along the canal.',
        ],
      },
      {
        time: 'Plan B · 8:30 PM',
        title: 'Evening stroll & souvenir shopping',
        place: 'Dotonbori / Shinsaibashi',
        maps: 'https://www.google.com/maps/search/?api=1&query=Shinsaibashi+Shopping+Street',
        type: 'suggestion',
        notes: [
          'Browse any remaining souvenir shops.',
          'Grab a dessert or convenience store snack.',
          'Spend a few quiet moments by the canal before heading back.',
        ],
      },
    ],
  },

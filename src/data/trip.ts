...
export const days: Day[] = [
  ...
  },
  {
    ...
    date: '2026-07-30',
    weekday: 'Thursday',
    title: 'Day 9: Universal Studios or Slow Osaka',
    summary:
      'Choose between a full day at Universal Studios Japan or a slower final day exploring Osaka Bay.',
    activities: [
      {
        time: 'Plan A · 7:00 AM',
      ...
      {
        time: 'Plan B · 9:30 AM',
        title: 'Slow breakfast in Namba',
        place: 'Namba',
        maps: 'https://www.google.com/maps/search/?api=1&query=Namba+Osaka+breakfast',
        type: 'food',
        notes: [
          'Enjoy a relaxed final morning without setting an early alarm.',
          'Choose a café, bakery or Japanese breakfast near the accommodation.',
          'Pack most of the luggage before leaving for Osaka Bay.',
        ],
      },
      {
        time: 'Plan B · 10:30 AM',
        title: 'Travel to Osaka Bay',
        place: 'Namba → Osakakō',
        type: 'train',
        notes: [
          'Travel to the Tempozan harbour area for the relaxed alternative day.',
          'Kaiyukan, the cruise, marketplace and Ferris wheel are all close together.',
        ],
      },
      {
        time: 'Plan B · 11:15 AM',
        title: 'Osaka Aquarium Kaiyukan',
        place: 'Tempozan Harbour Village',
        maps: 'https://www.google.com/maps/search/?api=1&query=Osaka+Aquarium+Kaiyukan',
        type: 'suggestion',
        notes: [
          'A large aquarium built around an enormous Pacific Ocean tank.',
          'See whale sharks, rays, seals, penguins and marine habitats from around the Pacific Rim.',
          'The route gradually spirals down around the central tank and normally takes around two hours.',
          'Book a timed ticket ahead and confirm the date-specific opening hours.',
        ],
      ...
      },
      {
        ...
        place: 'Tempozan',
        maps: 'https://www.google.com/maps/search/?api=1&query=Tempozan+Marketplace',
        type: 'food',
        notes: [
          'A covered dining and shopping complex beside Kaiyukan.',
          'Choose an easy lunch from the restaurants or Naniwa Kuishinbo Yokocho food area.',
          'Use this as a proper air-conditioned rest before the cruise.',
        ],
        link: 'https://osaka-info.jp/en/spot/tempozan-marketplace/',
      },
      {
        time: 'Plan B · 3:00 PM',
        title: 'Santa Maria Osaka Bay cruise',
        place: 'Kaiyukan West Wharf',
        maps: 'https://www.google.com/maps/search/?api=1&query=Santa+Maria+Cruise+Osaka',
        type: 'suggestion',
        notes: [
          'A relaxed 45-minute harbour cruise aboard a large sightseeing ship.',
          'See Osaka Bay, the harbour bridges, waterfront skyline and Universal Studios area from the water.',
          'Confirm the exact departure schedule and book once the group chooses this plan.',
          'The twilight cruise does not normally operate on Thursdays, so use a daytime departure.',
        ],
      ...
      },
      {
        ...
        place: 'Tempozan Harbour Village',
        maps: 'https://www.google.com/maps/search/?api=1&query=Tempozan+Ferris+Wheel',
        type: 'suggestion',
        notes: [
          'A short, peaceful ride with views across Osaka Bay and the surrounding city.',
          'Choose a transparent-floor gondola if everyone feels brave.',
          'Optional if the group would rather return to the hotel earlier.',
        ],
        link: 'https://tempozan-kanransya.com/tempozan-kanransya.com/en/',
      },
      {
        time: 'Plan B · 5:30 PM',
        title: 'Return, rest and finish packing',
        place: 'Osaka accommodation',
        type: 'stay',
        notes: [
          'Return to Namba with plenty of time to shower, rest and pack.',
          'Prepare passports, travel clothes and airport essentials for the morning.',
        ],
      },
      {
        time: 'Plan B · 7:30 PM',
        ...
        place: 'Namba',
        maps: 'https://www.google.com/maps/search/?api=1&query=Namba+Osaka+restaurants',
        type: 'food',
        notes: [
          'Choose one final meal close to the accommodation rather than crossing the city again.',
          'Consider yakiniku, sushi, teppanyaki or a relaxed izakaya.',
          'Finish early enough for a proper sleep before the airport transfer.',
        ],
      },
    ],
  },

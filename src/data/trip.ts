...
export const trip = {
  ...
  tagline:
    'Japan with the three of us — eleven days, four cities and a lot to look forward to 🇯🇵',
  heroImage:
...
export const days: Day[] = [
  ...
  },
  {
    ...
    summary:
      'Private tour of the Mt Fuji area and Hakone, with pickup direct from the Tokyo accommodation.',
    activities: [
      {
        time: '9:00 AM',
        title: 'Private Mt Fuji & Hakone tour',
        place: 'Mt Fuji area & Hakone',
        type: 'booking',
        notes: [
          'Travel by private vehicle with an English-speaking guide sharing stories and history along the way.',
          'See Mount Fuji, admired for its near-perfect symmetry and deep cultural significance.',
          'Enjoy peaceful lakeside views at Lake Ashi with Mt Fuji as a backdrop.',
          'Ride the Hakone Ropeway for panoramic views over the volcanic landscape.',
          'Visit Owakudani to see the dramatic volcanic activity — and try the famous black eggs.',
          'Pickup at 9:00 AM from NC Square Shinjuku (the Tokyo accommodation); drop-off at approximately 4:00 PM at the Hakone accommodation.',
          'Meals, personal expenses and some entrance fees are not included.',
        ],
        link: 'https://drive.google.com/drive/folders/1IPnKFy5tydO5V_Ib3UDQLCUGPWGopvyR?usp=drive_link',
      },
      {
        time: '4:45 PM',
  ...
  },
  {
    ...
    date: '2026-07-30',
    weekday: 'Thursday',
    title: 'Day 9: Last Day in Osaka',
    summary:
      'Choose between Universal Studios Japan or a relaxed final day cycling around Osaka Castle, exploring the city and finishing with sumo and one last night in Namba.',
    activities: [
      {
        time: 'Plan A · 7:00 AM',
        ...
        notes: [
          ...
          'The gates may open earlier than advertised on busy days.',
      ...
      {
        time: 'Plan A · Evening',
        title: 'Return and pack',
        place: 'Osaka accommodation',
        type: 'stay',
        notes: [
          'Have a simple dinner near Universal City or the accommodation.',
          'Pack before bed for the early airport transfer.',
          'Prepare passports, airport clothes and travel essentials.',
        ],
      },
  
      {
        ...
        place: 'Namba',
        maps:
          'https://www.google.com/maps/search/?api=1&query=Namba+Osaka+breakfast',
        type: 'food',
        notes: [
          'Start the final day with a relaxed breakfast near the accommodation.',
          'Bring water, sunscreen and something to cover up from the sun.',
          'Aim to leave for Osaka Castle at around 8:30 AM.',
        ],
      },
      {
        time: 'Plan B · 8:30 AM',
        title: 'Travel to Osaka Castle',
        place: 'Namba → Morinomiya',
        maps:
          'https://www.google.com/maps/dir/?api=1&origin=Namba+Station+Osaka&destination=Morinomiya+Station+Osaka',
        type: 'train',
        notes: [
          'Travel by Osaka Metro from Namba to Morinomiya Station.',
          'The journey should take approximately 25–35 minutes, depending on the connection.',
          'Morinomiya places you beside Osaka Castle Park and nearby shared-bike stations.',
        ],
      },
      {
        time: 'Plan B · 9:00 AM',
        title: 'Pick up shared bikes',
        place: 'Morinomiya Station',
        maps:
          'https://www.google.com/maps/search/?api=1&query=HELLO+CYCLING+Morinomiya+Station+Osaka',
        type: 'suggestion',
        notes: [
          'Use the HELLO CYCLING app to rent electric-assist bikes from a nearby street station.',
          'Check live availability before travelling and confirm that three bikes are available.',
          'The bikes have baskets for small bags and drinks.',
          'Check nearby return stations before beginning the ride.',
        ],
        link: 'https://www.hellocycling.jp/',
      },
      {
        time: 'Plan B · 9:15 AM',
        title: 'Cycle around Osaka Castle and the river',
        place: 'Osaka Castle Park → Okawa River',
        maps:
          'https://www.google.com/maps/search/?api=1&query=Osaka+Castle+Park',
        type: 'experience',
        notes: [
          'Cycle around the castle’s outer moats, park paths and tree-lined surroundings.',
          'Continue towards the Okawa River and Sakuranomiya Park if everyone is comfortable.',
          'The area is mostly flat and the electric-assist bikes should make the ride easy.',
          'Ride slowly near pedestrians and walk the bikes through crowded sections.',
          'Allow approximately 60–90 minutes depending on the heat.',
        ],
      },
      {
        time: 'Plan B · 10:30 AM',
        title: 'Return the bikes',
        place: 'Osaka Castle Park or Morinomiya',
        type: 'suggestion',
        notes: [
          'Use the app to find a HELLO CYCLING station with three available return spaces.',
          'Return the bikes near Osaka Castle Park or back at Morinomiya.',
          'Confirm that every bike has successfully registered as returned before leaving.',
        ],
        link: 'https://www.hellocycling.jp/map/',
      },
      {
        time: 'Plan B · 10:45 AM',
        title: 'Explore Osaka Castle',
        place: 'Osaka Castle',
        maps:
          'https://www.google.com/maps/search/?api=1&query=Osaka+Castle',
        type: 'sight',
        notes: [
          'Walk through the inner grounds and see Osaka’s most recognisable historic landmark.',
          'Visit the museum and observation level inside the reconstructed castle tower if interested.',
          'Spend more time indoors as the temperature rises.',
          'Allow approximately 90 minutes.',
        ],
        link: 'https://www.osakacastle.net/',
      },
      {
        time: 'Plan B · 12:30 PM',
        title: 'Lunch near Osaka Castle',
        place: 'JO-TERRACE OSAKA or Miraiza Osaka Castle',
        maps:
          'https://www.google.com/maps/search/?api=1&query=JO-TERRACE+OSAKA',
        type: 'food',
        notes: [
          'Have lunch somewhere indoors and air-conditioned near the castle.',
          'Choose based on what looks good and how busy each restaurant is.',
          'Use this as a proper break after cycling and exploring the castle.',
        ],
      },
      {
        time: 'Plan B · 1:45 PM',
        title: 'Travel back to Namba',
        place: 'Osaka Castle → Namba',
        maps:
          'https://www.google.com/maps/dir/?api=1&origin=Osaka+Castle&destination=Namba+Station+Osaka',
        type: 'train',
        notes: [
          'Return to Namba before the hottest part of the afternoon continues.',
          'Pick up any drinks or snacks needed for the accommodation.',
        ],
      },
      {
        time: 'Plan B · 2:15 PM',
        title: 'Rest and begin packing',
        place: 'Osaka accommodation',
        type: 'stay',
        notes: [
          'Cool down, shower and rest after the morning ride.',
          'Begin packing the suitcases and safely store the painted daruma.',
          'Leave out only the clothes and essentials needed for the final evening and airport journey.',
        ],
      },
      {
        time: 'Plan B · 4:30 PM',
        title: 'Head to the sumo hall',
        place: 'Namba',
        maps:
          'https://www.google.com/maps/search/?api=1&query=THE+SUMO+HALL+HIRAKUZA+OSAKA',
        type: 'suggestion',
        notes: [
          'The sumo hall is conveniently located around the Namba area.',
          'Arrive early enough to find the venue and complete check-in.',
          'Book ahead if the group decides to include the show.',
        ],
      },
      {
        time: 'Plan B · 5:00 PM',
        title: 'HIRAKUZA sumo show',
        place: 'THE SUMO HALL HIRAKUZA OSAKA',
        maps:
          'https://www.google.com/maps/search/?api=1&query=THE+SUMO+HALL+HIRAKUZA+OSAKA',
        type: 'suggestion',
        notes: [
          'A live entertainment show introducing sumo through matches, performance, sound and lighting.',
          'The experience lasts approximately two hours.',
          'A memorable indoor activity for the final evening in Japan.',
          'Keep this marked as a suggestion until tickets are purchased.',
        ],
        link: 'https://en.hirakuza.net/osaka/',
      },
      {
        time: 'Plan B · 7:15 PM',
        title: 'Final dinner in Osaka',
        place: 'Namba or Dotonbori',
        maps:
          'https://www.google.com/maps/search/?api=1&query=Dotonbori+Osaka',
        type: 'food',
        notes: [
          'Choose one final meal from anything still left on the Japan food list.',
          'Consider yakiniku, sushi, okonomiyaki, ramen or a relaxed izakaya.',
          'Stay close to the accommodation so the evening remains easy.',
        ],
      },
      {
        time: 'Plan B · 8:30 PM',
        title: 'One last walk through Osaka',
        place: 'Dotonbori and Shinsaibashi',
        maps:
          'https://www.google.com/maps/search/?api=1&query=Shinsaibashi+Shopping+Street',
        type: 'suggestion',
        notes: [
          'Take one final walk beside the Dotonbori canal and through the surrounding streets.',
          'Pick up any last-minute souvenirs, desserts or convenience-store snacks.',
          'Keep the finish time flexible depending on everyone’s energy.',
        ],
      },
      {
        time: 'Plan B · 9:30 PM',
        ...
        type: 'stay',
        notes: [
          'Finish packing and check that passports and travel documents are ready.',
          'Prepare airport clothes, chargers and anything needed during the flight.',
          'Set alarms and confirm the morning route to Kansai Airport.',
        ],
      },
    ],
  },
